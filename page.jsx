  ...
  return (
    <div>
      ...
      <section style={{ background: `linear-gradient(135deg,${colors.primary},#1d4ed8)`, color: "#fff", padding: "72px 24px", textAlign: "center" }}>
        ...
        <Btn onClick={() => setPage("register")} variant="accent" size="lg">Register Now — It is Free</Btn>
      </section>
    </div>
  );
};
    ...
    <div style={{ background: colors.bg, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 24px" }}>
        ...
        <Card>
          ...
          <p style={{ color: colors.muted, fontSize: 14, marginBottom: 20 }}>Do not see your neighborhood? Let us know and we will evaluate adding it.</p>
          {submitted ? (
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "60px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
          <Card>
            ...
            <p style={{ color: colors.muted, fontSize: 14, lineHeight: 1.7 }}>If your card is lost or stolen, report it immediately. Your remaining balance will be transferred to a new card after a $2 replacement fee.</p>
          </Card>
          <Card>
            <h3 style={{ fontWeight: 700, color: colors.dark, marginBottom: 10 }}>↩️ Refund Policy</h3>
            <p style={{ color: colors.muted, fontSize: 14, lineHeight: 1.7 }}>Unused balance can be refunded upon graduation or withdrawal. Submit a refund request at least 5 business days before your final exam date.</p>
          </Card>
        </div>
      </div>
    </div>
